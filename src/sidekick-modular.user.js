...
// @version      5.1.0
// @description  Modular version of Sidekick - Enhanced Torn.com sidebar with page-specific layouts, notepads, todo lists, attack lists, cooldown timers, travel tracker, points monitor, clock, and debugging tools
...
// @grant        GM_setValue
// @grant        GM_getValue
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/core.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/ui.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/content.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/settings.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/clock.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/notepad.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/flight-tracker.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@3f34be4/src/modules/global-functions.module.js
// @run-at       document-end
// ==/UserScript==
...
(function() {
    ...
    console.log("🚀 SIDEKICK MODULAR STARTING v5.1.0 - " + new Date().toLocaleTimeString());
    console.log("🎯 PAGE-SPECIFIC LAYOUTS: New pages start clean, positions per page, content global");
