...
// @grant        GM_setValue
// @grant        GM_getValue
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/core.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/ui.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/content.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/settings.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/clock.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/notepad.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/flight-tracker.module.js
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@853fde4/src/modules/global-functions.module.js
// @run-at       document-end
// ==/UserScript==
...
(function() {
    ...
    console.log("🚀 SIDEKICK MODULAR STARTING v4.4.0 - " + new Date().toLocaleTimeString());
    console.log("🔧 CRITICAL FIXES: Mass deletion, immediate UI updates, travel tracker restored");
