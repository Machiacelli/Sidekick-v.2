...
// @version      5.76.0
// @description  Stock Ticker MAJOR UPGRADE - Auto-tracks transactions for profit/loss calculation!
// @author       Machiacelli
...
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@a890e82/src/modules/stockticker.module.js?v=20250129
...
(function() {
    ...
    console.log('🚀 Sidekick Modular CDN v5.76.0 - Stock Ticker with Transaction Tracking!');
    console.log('💰 NEW: Auto-tracks buy/sell transactions for accurate profit/loss calculation');
