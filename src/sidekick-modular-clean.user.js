...
// @version      5.61.0
// @description  FIXED: Stock Ticker scrollbar hidden + API debugging added
// @author       Machiacelli
...
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@a9a349f/src/modules/stockticker.module.js?v=20250129
...
(function() {
    ...
    console.log('🚀 Sidekick Modular CDN v5.61.0 - Stock Ticker scrollbar hidden + API debug!');
