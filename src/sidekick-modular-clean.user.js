...
// @version      5.69.0
// @description  FIXED: Stock Ticker prices now showing + settings window close button working
// @author       Machiacelli
...
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@ce5c9c8/src/modules/stockticker.module.js?v=20250129
...
(function() {
    ...
    console.log('🚀 Sidekick Modular CDN v5.69.0 - Stock Ticker prices fixed!');
