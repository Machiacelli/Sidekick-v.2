...
// @grant        GM_addStyle
// @grant        GM_setValue
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/core.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/ui.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/content.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/settings.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/clock.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/notepad.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/blocktraining.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/global-functions.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/attacklist.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/linkgroup.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/travel-blocker.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/traveltracker.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/timer.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/randomtarget.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/plane-replacer.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@9cdee9a/src/modules/autogym.module.js?v=2
// @require      https://cdn.jsdelivr.net/gh/Machiacelli/Sidekick-v.2@df316a3/src/modules/todolist.module.js?v=2
// @run-at       document-end
// ==/UserScript==
...
(function() {
    ...
    console.log("�🚀 SIDEKICK MODULAR STARTING v5.13.1 - " + new Date().toLocaleTimeString());
